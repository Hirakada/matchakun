...
export default function OrderPopup({
  ...
  const items = [
    ...
    {
      title: "Order Here",
      description: "Order via Matcha Kun",
      href: "/order",
      icon: ShoppingBag,
      external: false,
    },
      ...
      <DialogContent className="w-[92vw] max-w-md rounded-[28px] border border-neutral-200 bg-neutral-white p-5 shadow-2xl sm:p-6">
        ...
        <div className="mt-5 flex flex-col gap-3 sm:mt-6">
          {items.map((item) => {
            ...
            const className =
              "group flex items-center justify-between rounded-2xl border border-neutral-200 bg-neutral-white p-3.5 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-300 hover:shadow-md sm:p-4";
